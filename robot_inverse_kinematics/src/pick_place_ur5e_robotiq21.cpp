...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface)
{
    ...
    collision_objects.resize(7);  // 1 Masa + 6 Küre
    ...
    collision_objects[0].primitives[0].dimensions = {1.3, 1.3, 0.2}; // (X, Y, Z)
    ...
    tf2::Quaternion q;
    q.setRPY(0, 0, M_PI/4);  // Yaw 45 derece
    ...
    for (int i = 1; i <= 6; i++)
    {
        ...
        collision_objects[i].primitives[0].dimensions[0] = 0.05; // Çap = 0.05m

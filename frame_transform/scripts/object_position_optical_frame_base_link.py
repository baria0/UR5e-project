...
class ConversionFrameServer(object):
    def __init__(self):
        ...
        self.listener.waitForTransform("/base_link", "rgbd_camera_optical_frame", rospy.Time(0), rospy.Duration(4.0))
    ...
    def conversion_callback(self, data):
        ...
        # convert coordinates from rgbd_camera_optical_frame frame to base_link frame
        point_camera = PointStamped()
        point_camera.header.frame_id = "rgbd_camera_optical_frame"
